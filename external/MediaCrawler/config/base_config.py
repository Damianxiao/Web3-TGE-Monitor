...
# 基础配置 - Web3 TGE监控专用
PLATFORM = "xhs"
KEYWORDS = "Web3"  # Web3关键词搜索配置
LOGIN_TYPE = "cookie"  # 优先使用cookie模式，失败时回退到qrcode
COOKIES = "abRequestId=f5f78ad5-ddea-5f8e-8fc8-25c91a8ac4da; a1=196bddd115240llo9uo9tt2s91lf61wk4sowjoe8250000102656; webId=b02f2dce588cff96203af0661213a419; gid=yjKDfffoKl8yyjKDfffqyyU11Vvhwi77UDyUjFWFiiTJx328yJ0VAT888KJyq2y8KDfWKDJ2; webBuild=4.72.0; xsecappid=xhs-pc-web; loadts=1737130424688; acw_tc=0a02833d17371304247234773e1b6a0a0c2e34b87f2b53e8c9e2c0e088cc95; websectiga=f6bc95a6b4a9a0d87bef3aa6a5ee4edc6b458ce6e8c2df75a93b3ee888a1eb69; sec_poison_id=03a9b2bf-2d5b-40fd-a481-05f6c64a3b0f; web_session=040069b1695b225677ab6387423a4b7e362a4d"
...
WEIBO_SEARCH_TYPE = "real_time"  # 使用实时搜索获取最新TGE信息
...
# 设置为True启用无头浏览器模式，提高爬取效率
# 只有在cookie失效或遇到验证码时才会回退到有界面模式
HEADLESS = True
